...
if __name__ == '__main__':
    train_feat = torch.randn(2000,192)
    train_lab = torch.ones(2000,1).long()
    test_feat = torch.randn(32,192)
    test_lab = torch.ones(32,1).long()

    a, b = knn_classifier(train_feat, train_lab, test_feat, test_lab, 20, 0.07, num_classes=2)